...
## 最新版本：`v2.25.0`（2026-09-17）

👉 [查看 Release 说明与校验和](https://github.com/redtidev1918/PixivFlow/releases/tag/v2.25.0)
...
| 平台 | 文件 | 大小 | 下载 |
|---|---|---|---|
| 通用 | `RELEASE-METADATA.json` | 2 KB | [⬇️ 下载](https://github.com/redtidev1918/PixivFlow/releases/download/v2.25.0/RELEASE-METADATA.json) |
| 通用 | `SHA256SUMS` | 0 KB | [⬇️ 下载](https://github.com/redtidev1918/PixivFlow/releases/download/v2.25.0/SHA256SUMS) |
| 通用 | `pixivflow-2.25.0.tgz` | 1.7 MB | [⬇️ 下载](https://github.com/redtidev1918/PixivFlow/releases/download/v2.25.0/pixivflow-2.25.0.tgz) |
