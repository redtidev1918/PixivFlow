...
## 最新版本：`v3.0.0`（2026-09-26）

👉 [查看 Release 说明与校验和](https://github.com/redtidev1918/PixivFlow/releases/tag/v3.0.0)
...
| 平台 | 文件 | 大小 | 下载 |
|---|---|---|---|
| 通用 | `RELEASE-METADATA.json` | 2 KB | [⬇️ 下载](https://github.com/redtidev1918/PixivFlow/releases/download/v3.0.0/RELEASE-METADATA.json) |
| 通用 | `SHA256SUMS` | 0 KB | [⬇️ 下载](https://github.com/redtidev1918/PixivFlow/releases/download/v3.0.0/SHA256SUMS) |
| 通用 | `pixivflow-3.0.0.tgz` | 2.4 MB | [⬇️ 下载](https://github.com/redtidev1918/PixivFlow/releases/download/v3.0.0/pixivflow-3.0.0.tgz) |
