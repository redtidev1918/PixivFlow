...
<!-- docsite-release-tag: v2.20.5 -->
# 📥 下载 PixivFlow

**语言 / Language:** 中文 · [English](/en/download.md)

<!-- docsite: generated from redtidev1918/PixivFlow release v2.20.5; do not edit by hand -->

本页由 GitHub Actions 在每次发版时**自动更新**，始终指向最新 Release。

## 最新版本：`v2.20.5`（2026-09-15）

👉 [查看 Release 说明与校验和](https://github.com/redtidev1918/PixivFlow/releases/tag/v2.20.5)
...
| 平台 | 文件 | 大小 | 下载 |
|---|---|---|---|
| 通用 | `SHA256SUMS` | 0 KB | [⬇️ 下载](https://github.com/redtidev1918/PixivFlow/releases/download/v2.20.5/SHA256SUMS) |
| 通用 | `pixivflow-2.20.5.tgz` | 1.7 MB | [⬇️ 下载](https://github.com/redtidev1918/PixivFlow/releases/download/v2.20.5/pixivflow-2.20.5.tgz) |
